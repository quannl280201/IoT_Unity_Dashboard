...
namespace Dashboard{
    ...
    public class ToggleSwitch : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        [SerializeField] public Text deviceName;
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            if (!pointerDown)
            {
                ...
                if(deviceName.GetComponent<Text>().text == "Pump"){
                    DashboardMqtt.MqttInstance.PublishPumpControl();
                }
                else if(deviceName.GetComponent<Text>().text == "LED")
                    DashboardMqtt.MqttInstance.PublishLEDControl();
            }
        }
